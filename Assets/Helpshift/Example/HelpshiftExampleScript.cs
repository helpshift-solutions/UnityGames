...
public class HelpshiftExampleScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        string apiKey = "gregfirstdemo_api_20181218185318633-5bc98b1f8e7f19d";
        string domainName = "https://gregfirstdemo.helpshift.com";
        string appId;
#if UNITY_ANDROID
		appId = "gregfirstdemo_platform_20200320115459853-05613388b7958e8";
#elif UNITY_IOS
        appId = "gregfirstdemo_platform_20200320115459831-8983dd5f081ed78";
#endif
